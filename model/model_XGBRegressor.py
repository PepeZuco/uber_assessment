...
numerical_cols = ['pick_lat', 'pick_lng', 'dropoff_lat', 'dropoff_lng', 'eta',
                  ...
                  'trip_distance_haversine', 'distance_from_center', 'direction_of_travel']  # Added 'direction_of_travel'

# Adding `pickup_month` as a categorical feature
categorical_cols = ['pickup_airport_code', 'dropoff_airport_code', 'pickup_day_of_the_week',
                    'pickup_hour_cat', 'pickup_month']  # Added 'pickup_month'

# Step 3: Creating interaction feature between 'pickup_hour' and 'pickup_day_of_the_week'
logging.info("Creating 'hour_day_of_week_interaction' feature...")
train_df['hour_day_of_week'] = train_df['pickup_hour'].astype(str) + "_" + train_df['pickup_day_of_the_week'].astype(str)
test_df['hour_day_of_week'] = test_df['pickup_hour'].astype(str) + "_" + test_df['pickup_day_of_the_week'].astype(str)

# Add this new interaction feature to categorical columns for One-Hot Encoding
...
# Step 5: One-Hot Encoding categorical columns
